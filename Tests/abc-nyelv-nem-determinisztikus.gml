...
<Automata Type="Automata.Finite.FiniteAutomata, Automata, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
    ...
    <Transitions>
        <Transition Type="Automata.Transition.SimpleTransition, Automata, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null" SourceStateId="A" TargetStateId="A" Symbols="abc" />
